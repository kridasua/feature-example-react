...
var TextElement = React.createClass({
  ...
  render: function() {
    ...
    console.log("rawMarkup", rawMarkup);
		this.id = "editor1";
    return (
      <div id="editor1" contentEditable={true} className="my-class" dangerouslySetInnerHTML={{__html: rawMarkup}}></div>
    )
  }
});
...
ReactDOM.render(
  <PanelContainer url="/api/panel/1"/>, document.getElementById('panel')
);
